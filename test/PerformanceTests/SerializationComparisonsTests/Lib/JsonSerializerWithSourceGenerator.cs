...
namespace ExperimentsLib
{
    ...
    /// </summary>
    public class JsonSerializerSourceGenerationPayloadWriter : IPayloadWriter<IEnumerable<Customer>>
    {
        /// <inheritdoc/>
        public async Task WritePayloadAsync(IEnumerable<Customer> payload, Stream stream, bool includeRawValues)
        {
            ...
            await JsonSerializer.SerializeAsync(stream, response, SourceGenerationContext.Default.ResponseWrapper) ;
        }
